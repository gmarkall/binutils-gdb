...
static bfd_boolean InsertImportEntry(const char *Name, Elf_Internal_Rela const *Rel, bfd_vma OutOffset, bfd_boolean Collect)

{
	...
	static Elf_Internal_Rela const *LastRel = NULL;
